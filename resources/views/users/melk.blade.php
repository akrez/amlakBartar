    ...
    <div class="form col-xs-8 col-sm-10" style="margin-top:50px; background-color:DarkGray; border-radius: 5px;">
        ...
        <form action="{{'sortMelk'}}" method="POST" enctype="multipart/form-data">
            <div class="form col-xs-8 col-sm-5" style="background-color:DarkGray ;">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="شماره همراه" name="phone" value="{{$phone }}">
                </div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="سال ساخت" name="Construction" value="{{$Construction}}">
                </div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="تعداد واحد در طبقه" name="units" value="{{$units}}">
                </div>
