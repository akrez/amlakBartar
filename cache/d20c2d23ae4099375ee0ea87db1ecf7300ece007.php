...
<div style="display:flex; justify-content:center;">
    <div class="col-xs-8 col-sm-4" style="margin-top:100px; background-color:DarkGray; border-radius: 5px;">
        ...
        <form action="<?php echo e('sort'); ?>" method="POST">

            <div class="form-group">
                <input type="text" class="form-control" placeholder="نام" name="name" value="<?php echo e($name); ?>">
            </div>

            <div class="form-group">
                <input type="email" class="form-control" placeholder="ایمیل" name="email" value="<?php echo e($email); ?>">
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AmlakBartar\resources\views/users/register.blade.php ENDPATH**/ ?>