...
<div style="display:flex; justify-content:center;">
    ...
    <form action="<?php echo e('sortMelk'); ?>" method="POST" enctype="multipart/form-data">
        <div class="form col-xs-8 col-sm-5" style="background-color:DarkGray ;">
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="مالک" name="owner" value="<?php echo e($owner); ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="آدرس" name="Address" value="<?php echo e($Address); ?>">
            </div>

            <div class="form-group">
                <input type="text" class="form-control" placeholder="سال ساخت" name="Construction"
                    value="<?php echo e($Construction); ?>">
            </div>

            <div class="form-group">
                <input type="text" class="form-control" placeholder="متراژ" name="Meterage" value="<?php echo e($Meterage); ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="تعداد طبقات" name="Floors" value="<?php echo e($Floors); ?>">
            </div>
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="طبقه چندم" name="Floor" value="<?php echo e($Floor); ?>">
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AmlakBartar\resources\views/users/melk.blade.php ENDPATH**/ ?>